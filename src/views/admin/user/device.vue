<template>
 ...
 <el-table-column prop="process" width="200px" align="center" label="工序">  -->
    ...
    <!-- <el-table-column class-name="status-col" label="工序" width="120" align="center">
      ...
      <!-- <el-table-column class-name="status-col" label="合作状态" width="120" align="center">
          ...
          <el-switch v-model="scope.row.State" :on-value="1" :off-value="0" on-color="#13ce66" off-color="#ff4949" on-text="启用" off-text="禁用">
          </el-switch>
  ...
  <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
    <el-form :model="form" :rules="rules" ref="form" label-width="100px">
        ...
        <el-form-item  v-if="dialogStatus=='update'" label="设备ID：" :label-width="formLabelWidth">
          <el-input v-model="form.MachID" auto-complete="off"></el-input>
        </el-form-item>
