<template>
  <div class="app-container calendar-list-container">
   ...
   状态：<el-select v-model="listQuery.QueryType" placeholder="请选择">
    <el-option
   ...
   <el-date-picker
    ...
    <el-table :key='tableKey' :data="list" v-loading.body="listLoading" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column prop="DownNum" width="100px" align="center" label="下载次数"> </el-table-column>


       <el-table-column prop="Time" width="200px" align="center" label="时间"> </el-table-column>
  
  
  
      <el-table-column prop="CompanyName" width="400px" align="center" label="上传方"> </el-table-column>  
      <el-table-column prop="CompanyName" width="400px" align="center" label="接收方"> </el-table-column>  
...
<script>
import { page, addObj, getObj, delObj, putObj } from "api/admin/FileLog/company";
